    ...
    <div className="slider slider-three">
      <div className="slider-stats-container">
        ...
        <div className="stat-cont">
          <div>Fuel Amount:</div>
          <div>
            {rocketInfo ? rocketInfo[1].second_stage.fuel_amount_tons : ""}
          </div>
        </div>
        <div className="stat-cont">
          <div>Burn Time:</div>
          <div>
            {rocketInfo ? rocketInfo[1].second_stage.burn_time_sec : ""}
          </div>
        </div>
        <div className="stat-cont">
          <div>Thrust at Sea Level:</div>
          <div>{rocketInfo ? rocketInfo[1].second_stage.thrust.kN : ""}</div>
        </div>
      </div>
    </div>
  );
