    ...
    <div className="slider slider-nine slider-three">
      <div className="slider-stats-container">
        ...
        <div className="stat-cont">
          ...
          <div>{rocketInfo ? rocketInfo[1].second_stage.engines : ""}</div>
        </div>
        <div className="stat-cont">
          <div>Fuel Amount:</div>
          <div>
            {rocketInfo ? rocketInfo[1].second_stage.fuel_amount_tons : ""}t
          </div>
        </div>
        <div className="stat-cont">
          <div>Burn Time:</div>
          <div>
            {rocketInfo ? rocketInfo[1].second_stage.burn_time_sec : ""}sec
          </div>
        </div>
        <div className="stat-cont">
          <div>Thrust at Sea Level:</div>
          <div>
            {rocketInfo ? rocketInfo[1].second_stage.thrust.kN : ""}kN /{" "}
            {rocketInfo ? rocketInfo[1].second_stage.thrust.lbf : ""}lbf
          </div>
        </div>
      </div>
    </div>
