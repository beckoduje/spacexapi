    ...
    <div className="slider slider-two">
      <div className="slider-stats-container">
        ...
        <div className="stat-cont">
          ...
          <div>{rocketInfo ? rocketInfo[1].engines.type : ""}</div>
        </div>
        <div className="stat-cont">
        ...
        <div className="stat-cont">
          <div>Fuel Amount:</div>
          <div>
            {rocketInfo ? rocketInfo[1].first_stage.fuel_amount_tons : ""}
          </div>
        </div>
        <div className="stat-cont">
          <div>Burn Time:</div>
          <div>{rocketInfo ? rocketInfo[1].first_stage.burn_time_sec : ""}</div>
        </div>
        <div className="stat-cont">
          <div>Thrust at Sea Level:</div>
          <div>
            {rocketInfo ? rocketInfo[1].first_stage.thrust_sea_level.kN : ""}
          </div>
        </div>
        <div className="stat-cont">
          <div>Thrust in Vacuum:</div>
          <div>
            {rocketInfo ? rocketInfo[1].first_stage.thrust_vacuum.kN : ""}
          </div>
        </div>
      </div>
    </div>
